...
find+replace, use a scripting language for your analyses, automatically save parameters in the filename.
...
backup regularly (daily!), versions of software & packages, store raw data & intermediate steps in data processing, store code & progress on code
...
It is usually a better idea to print your results to a file rather than to the console. (Why?)

Return to the R Notebook that you last updated in Exercise 4.\
Use this line of code to print your `results` to a comma separated values (.csv) file called "myResuts.csv":
...
Use `the_filename` to print your results to a csv file.

...
This notebook is meant to introduce you to simulations and calculations using R. In the following, we will simulate the  rescue model introduced in the lecture.
